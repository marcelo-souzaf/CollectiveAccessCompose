...
#
date_default_timezone_set(getenv('CA_TIMEZONE'));
...
if (!defined("__CA_QUEUE_ENABLED__")) {
	define("__CA_QUEUE_ENABLED__", getenv("CA_QUEUE_ENABLED"));
}
...
if (!defined("__CA_DEFAULT_LOCALE__")) {
	define("__CA_DEFAULT_LOCALE__", getenv("CA_DEFAULT_LOCALE"));
}
...
# 
define("__CA_USE_CLEAN_URLS__", getenv("CA_USE_CLEAN_URLS"));
